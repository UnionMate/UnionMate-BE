...
public class InterviewEvaluationCreateService {

	private final InterviewEvaluationRepository interviewEvaluationRepository;

	@Transactional
	public void create(InterviewEvaluation interviewEvaluation) {
		interviewEvaluationRepository.save(interviewEvaluation);
	}
}
